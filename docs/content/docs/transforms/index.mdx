...
Administrators can also write JavaScript transforms with the `js:` ID prefix.
They run in an embedded QuickJS sandbox and attach to the same chains as built-in transforms.
See [Custom JS Transforms](/en/docs/transforms/custom-js).
